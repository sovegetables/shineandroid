...
package com.sovegatable.bottomtab.tab;
...
import com.sovegatable.bottomtab.R;
...
/**
 * 基于原生的TabLayout修改:
 *  基于OnTabSelectedListener接口添加了boolean onTabPreSelected(Tab tab)方法
 *  这个方法返回true, 不会切换到相应的Tab;否则就切换到相应的Tab
 *
 */
@ViewPager.DecorView
public class TabLayout extends HorizontalScrollView {
    ...
    public interface OnTabSelectedListener {
         ...
         */
        public boolean onTabPreSelected(Tab tab);
    ...
    boolean preSelectTab(Tab tab){
        final Tab currentTab = mSelectedTab;
        if(currentTab != tab){
            if (tab != null) {
                return dispatchTabPreSelected(tab);
            }
        }
        return false;
    }
    ...
    private boolean dispatchTabPreSelected(@NonNull final Tab tab){
        for (int i = mSelectedListeners.size() - 1; i >= 0; i--) {
            return mSelectedListeners.get(i).onTabPreSelected(tab);
        }
        return false;
    }
    ...
    public static final class Tab {
        ...
        public boolean preSelected() {
            ...
            return mParent.preSelectTab(this);
        }
